...
void quicksort(type_list *L, int extizq, int extder){
    int i, j, aux=1;
    if(extizq < extder){
...
void mezcla(type_list *L, int extizq, int extder){
    int medio, i , j, x;
    int temp[TAM];
    if(extizq < extder){
            ...
            switch (menu()) {
               ...
               case 9:
                        ...
                        switch(opc2){
                            ...
                            case 3:quicksort(lista2,0,lista2->ultimo);break;
                            case 4:mezcla(lista2,0,lista2->ultimo);break;
                        }
